...
public class ScreenHandlerTypes {
    ...
    public static final ScreenHandlerType<BlingPressScreenHandler> BLING_PRESS_SCREEN_HANDLER = Registry.register(Registries.SCREEN_HANDLER,Identifier.of(CypherDuxMod.MOD_ID,"bling_press"), new ExtendedScreenHandlerType<>(BlingPressScreenHandler::new, BlockPos.PACKET_CODEC));
