...
public class ModSounds {
    ...
    public static SoundEvent BLING = register("music_disc.casino");
    public static final RegistryKey<JukeboxSong> BLING_KEY = RegistryKey.of(RegistryKeys.JUKEBOX_SONG, Identifier.of(CypherDuxMod.MOD_ID,"casino"));
}
